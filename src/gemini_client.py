...
1. 美国大盘指数3种 + KOSPI +VIX (只要5种）
2. 美股市场动向（大盘走向 / 核心驱动因素 / 科技巨头 / 热门异动股 / 航天板块）每条信息之间空一行
3. 全球主要地缘政治动态3条（重大事件及其对全球经济 / 能源 / 供应链的潜在影响）每条信息之间空一行
4. 韩国头条 每条信息之间空一行
5. 中国头条 每条信息之间空一行
6. QQQM / SCHD / SPYM / RKLB 收盘价格含涨跌幅,52周最高回撤率=52W MDD  如 QQQM:284.98 （-1.87%）52W MDD (-7.43%)
